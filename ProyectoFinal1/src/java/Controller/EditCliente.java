...
@WebServlet(name = "EditCliente", urlPatterns = {"/EditCliente"})
...
response.setContentType("text/html;charset=UTF-8");
            ...
            BeanCliente tr= new BeanCliente(); 
            ...
            request.getRequestDispatcher("HomeClientes.jsp").forward(request, response); 
