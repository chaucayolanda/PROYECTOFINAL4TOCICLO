        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <h1 class="text-titles"><i class="zmdi zmdi-local-dining"></i> Productos</h1>
                </div>
                <p class="lead">Estimado Usuario, en esta sección se visualizarán los productos actualmente registrados en el sistema.</p>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade active in" id="list">
                                <div class="table-responsive">
                                    <table id="productos" class="table table-hover text-center">
                                        <thead>
                                            <tr>                                                
                                        ...
                                        <%
                                            try {
                                                String sql = "SELECT P.COD_PRODUCTO, M.NOMBRE, P.DESCRIPCION, P.PRECIO_VENTA, P.PRESENTACION, P.STOCK FROM PRODUCTO P INNER JOIN MARCA M ON P.COD_MARCA = M.COD_MARCA ORDER BY COD_PRODUCTO DESC";
                                                rs = sta.executeQuery(sql);
                                        %>
                                        <tbody>
                                            <%
                                            ...
                                            <tr>                                                
                                                ...
                                                <td><a href='.jsp?cod=<%=rs.getString(1)%>'class="btn btn-danger btn-raised btn-xs"><i class="zmdi zmdi-delete"></i></a></td>
                                            </tr>
                                            <% }
                                                } catch (SQLException e) {
                                                    out.println(e);
